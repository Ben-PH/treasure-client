...
use crate::ametheed::assets::storage::ProcessingState;
use crate::ametheed::assets::reload::HotReloadStrategy;
use crate::ametheed::assets::storage::AssetStorage;
use crate::ametheed::assets::timing::Time;
use crate::ametheed::core::transform::components::parent::Parent;
use crate::ametheed::assets::prefab::PrefabTag;
use crate::ametheed::assets::prefab::Prefab;
use crate::ametheed::assets::Handle;
use std::marker::PhantomData;
use crate::ametheed::assets::prefab::PrefabData;
use crate::ametheed::assets::system_desc::SystemDesc;
use crate::ametheed::assets::progress::Completion;
use specs::prelude::*;
            ...
            |mut d| {
                ...
                if !d.loading()
                    && !d
                        ...
                        .with_context(|_| seed::error!("Failed starting sub asset loading"))?
                {
                ...
                match d.progress().complete() {
                    ...
                    Completion::Failed => {
                        seed::error!("Failed loading sub asset: {:?}", d.progress().errors());
